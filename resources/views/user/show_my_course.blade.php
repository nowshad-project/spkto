				...
				<ul class="breadcrumbs" itemscope="" itemtype="http://schema.org/BreadcrumbList">
					<li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
						<span itemprop="name">
							...
							<span> > </span>
							<a href="{{asset('/')}}user/my-course">My course</a>	
						</span>
					</li>
                </ul>
            </div>
			...
			<div class="tab_section_button">
				<div class="container">
					<div class="as_tab_section">
						<ul class="clearfix">
							<li><a href="{{asset('/')}}user/create-course">Create course</a></li>
							<li class="active_tab"><a href="{{asset('/')}}user/my-course">My course</a></li>
						</ul>
					</div>
				</div>
			</div>
