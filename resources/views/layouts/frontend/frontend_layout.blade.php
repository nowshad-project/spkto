...
<body>
	...
	<div class="container">
		...
		<div class="alert" style=" background-color: #4CAF50; color: #fff;">
		  <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
		  <strong>Success! </strong> {{ session()->get('success') }}{{ session()->forget('success') }}
		</div>
		@endif
		@if(session()->exists('info'))
		<div class="alert" style=" background-color: #2196F3; color: #fff;">
		  <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
		  <strong>Info!</strong> {{ session()->get('info') }}{{ session()->forget('info') }}
		</div>
		@endif
		@if(session()->exists('warning'))
		<div class="alert" style=" background-color: #ff9800; color: #fff;">
		  <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
